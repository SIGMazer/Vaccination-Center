...
class vaccineuser {
    ...
    function __construct() {
        ...
        $sql = "SELECT * FROM vaccineuser,vaccinereservation where vaccineuser['UserID']=$_Session['UserID']";
        ...
        $this->SecondDoseDate=$row['SecondDoseDate'];
	}
    ...
    public function reserveDose(center_contactNum,vaccine_ID,reservationDate){
        $sql = "INSERT INTO vaccinereservation($Center_ContactNum,$vaccine_ID) values($this->Center_ContactNum,$this->vaccine_ID),vaccineuser($SecondDoseDate) values($this->SecondDoseDate)";
